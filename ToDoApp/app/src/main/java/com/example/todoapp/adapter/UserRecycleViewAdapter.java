...
public class UserRecycleViewAdapter extends RecyclerView.Adapter<UserRecycleViewAdapter.ItemViewHolder> {
    ...
    private UserRecycleViewAdapter.ItemUserListener itemListener;
    ...
    public void setItemListener(UserRecycleViewAdapter.ItemUserListener itemListener) {
    ...
    public void onBindViewHolder(@NonNull ItemViewHolder holder, int position) {
        ...
        holder.role.setText("Vai trò: "+user.getType());
        holder.user.setText("TK: "+user.getUsername());
        holder.pass.setText("MK: "+user.getPassword());
    }
